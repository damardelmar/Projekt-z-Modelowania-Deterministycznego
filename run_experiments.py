...
a = Apartment(6, 4, 4 * 60, f, 0, avg_temp_outside=0)
a.add_x_wall(0, 3.5, 2)
a.add_x_wall(4.25, 6, 2)
...
b = Apartment(6, 4, 60, f, 1500, avg_temp_outside=0)
b.u[0, :, :] = a.u[-1, :, :]
b.add_x_wall(0, 3.5, 2)
b.add_x_wall(4.25, 6, 2)
...
a = Apartment(6, 4, 4 * 60, f, 0, avg_temp_outside=5)
a.add_x_wall(0, 3.5, 2)
a.add_x_wall(4.25, 6, 2)
...
b = Apartment(6, 4, 60, f, 1500, avg_temp_outside=5)
b.u[0, :, :] = a.u[-1, :, :]
b.add_x_wall(0, 3.5, 2)
b.add_x_wall(4.25, 6, 2)
